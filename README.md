...
[![GitHub](https://github.com/danomagnum/opcua/workflows/gopuca/badge.svg)](https://github.com/danomagnum/opcua/actions)
[![Go Reference](https://pkg.go.dev/badge/github.com/danomagnum/opcua.svg)](https://pkg.go.dev/github.com/danomagnum/opcua)
[![License](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/danomagnum/opcua/blob/master/LICENSE)
[![Version](https://img.shields.io/github/tag/gopcua/opcua.svg?color=blue&label=version)](https://github.com/danomagnum/opcua/releases)
...
```sh
# install library
go get -u github.com/danomagnum/opcua
...
The [Current State](https://github.com/danomagnum/opcua/wiki/Current-State) was moved
to the [Wiki](https://github.com/danomagnum/opcua/wiki).
...
The [Gopcua Team](https://github.com/danomagnum/opcua/graphs/contributors).
...
[MIT](https://github.com/danomagnum/opcua/blob/master/LICENSE)
